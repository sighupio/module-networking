...
- [[#112](https://github.com/sighupio/module-networking/pull/112)] **Rename ConfigMap**: ConfigMaps holding Grafana Dashboards for Cilium and Hubble (`kube-system/cilium-grafana-dashboard` and `kube-system/hubble-grafana-dashboard`) have been renamed to follow the upstream names.
